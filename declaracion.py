...
def main(page: ft.Page):
    ...
    def mover_boton_no(e):
        ...
        while (abs(nuevo_top - top_actual) < movimiento_minimo or
                abs(nuevo_left - left_actual) < movimiento_minimo):
    ...
    def mostrar_respuesta(e):
        page.dialog = ft.AlertDialog(
            title= ft.Text('SABÍA QUE IBAS A DECIR QUE SI! <3'),
    ...
    btn_no = ft.ElevatedButton('No', width=100, on_click=mover_boton_no)
